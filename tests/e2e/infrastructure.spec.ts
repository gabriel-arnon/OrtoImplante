...
const validRequest: ValidatedContactRequest = {
  ...
  description:
    "Mensagem ficticia para validar o fluxo sem dados pessoais reais ou conteudo herdado.",
...
const emailEnv: ServerEnv = {
  ...
  CONTACT_EMAIL_TO: "destinatario@example.test",
  CONTACT_EMAIL_FROM: "site@example.test",
