      ...
      <div className="section-shell">
        <div id="regioes" className="max-w-3xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold text-navy md:text-4xl">
            Canais pendentes de confirmacao
          </h2>
        ...
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-navy">Status dos canais</h3>
          ...
          <p className="mt-4 text-sm leading-6 text-graphite-soft">
            A lista e provisoria e nao representa canais finais de atendimento.
          </p>
        </div>
      </div>
    </section>
