        ...
        <div>
          <div id="situacoes" className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-navy md:text-4xl">
              Temas para organizar o contato inicial
            </h2>
          </div>
          <div className="mt-7 sm:hidden">
            ...
            >
              <div className="min-h-0 overflow-hidden">
                <ul
                  className="mt-2.5 grid items-stretch gap-2.5"
                  data-situation-list="mobile-additional"
                >
                  {additionalMobileSituationCards.map((item) => (
                    <SituationCard key={item} item={item} isFocusable={showAllMobileCards} />
                  ))}
                </ul>
              </div>
            </div>
            ...
            >
              {showAllMobileCards ? "Ocultar outros assuntos" : "Ver outros assuntos"}
            </button>
          </div>
          <ul
